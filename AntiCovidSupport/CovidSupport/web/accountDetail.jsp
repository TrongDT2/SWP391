                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="first_name" id="first_name" value="${sessionScope.data_session.username}" title="enter your first name if any." readonly="">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <textarea rows="9" cols="70" class="form-control" id="location" title="enter a location">

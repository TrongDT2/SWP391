<%-- 
    Document   : addNewsManager
    Created on : Mar 27, 2022, 10:19:27 AM
    Author     : Aur
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                        <form class="form" action="addNewsController" method="post" >
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="id" value="${news.news_id}" >
                                    </div>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="hidden" class="form-control" name="author" id="phone" value="${sessionScope.data_session.user_id}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-6">  
